...
describe("axe a11y", () => {
  ...
  it("dashboard has no detectable violations", async () => {
    vi.spyOn(api, "listMigrations").mockResolvedValue([
      { id: "r1", status: "Running", wizardStep: 5, from: "imap", to: "graph", isBatch: true, scopeSummary: "218 mailboxes", mailboxCount: 218, progress: { migrated: 1, total: 2, currentFolder: null, msgPerMin: 1 }, createdAt: "2026-06-01T00:00:00Z" },
    ] as never);
